...
class leaveController extends Controller
{
    ...
    public function allLeaveApplication(){
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://hrm.aamarpay.dev/api/all-leave-application-only-for-hr',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
        ...
        return view('frontend.allLeaveApplication',compact('leaveApplicationList'), ['jwtToken' => $access_token]);
    }
