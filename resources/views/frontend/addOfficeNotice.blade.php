            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title"> Add Office Notice</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active">Add Office Notice</li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                            <form method="post" action="{{route('createOfficeNotice')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Notice Description<span class="text-danger">*</span></label>
                                    <textarea id="notice" name="notice"></textarea></br>
