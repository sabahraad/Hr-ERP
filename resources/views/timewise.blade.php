                            ...
                            <div class="main-menu-wrapper">
                                <div class="menu-header">
                                    <a href="index.html" class="menu-logo">
                                        <img src="{{asset('images/favicon.png')}}" class="img-fluid" alt="Logo">
                                    </a>
                                ...
                                <div class="try-free link mobile-head-menu">
                                    <a class="btn btn-primary mobile-head-free-button" href="https://themeforest.net/item/smarthr-bootstrap-admin-panel-template/21153150" target="_blank"  role="button">Try It Free</a>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-12 col-12 res-center">
                                <div class="site">
                                    ...
                                    <div class="site-brand">
                                        <a href="index.html" class="site-brand-logo"><img src="{{asset('images/favicon.png')}}" alt="logo" class="img-fluid"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-10 col-sm-10 col-9" data-aos="fade-up" data-aos-duration="2000">
                            <div class="admin-slider">
                                <div class="owl-carousel my-carousel bannercar">
                                    ...
                                    <div class="my-carousel-item"><img src="{{asset('images/App-Banner-995x623-02.png')}}" alt=""></div>
                                    <div class="my-carousel-item"><img src="{{asset('images/App-Banner-995x623-03.png')}}" alt=""></div>
                                    <div class="my-carousel-item"><img src="{{asset('images/App-Banner-995x623-04.png')}}" alt=""></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-12 col-lg-12">
                                    <div class="owl-carousel owl-theme cr-slider" id="owl-carousel">
                                        <div class="list-item text-center item ratings-slider">
                                            <div class="customer-quote"><img src="{{asset('images/quote-right.png')}}"  alt="img"></div>
